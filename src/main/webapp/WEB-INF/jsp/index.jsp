...
<div class="layui-layout layui-layout-admin">
	<div class="layui-header">
		...
		<ul class="layui-nav layui-layout-left">
			<c:forEach items="${authorityList}" var="map">
				<li class="layui-nav-item">
					...
					<dl class="layui-nav-child" style="padding-left: 15px">
						<c:forEach items="${map.list}" var="temp">
							<dd>
								<a class="hp-tab-add" hp-href="${temp.authorityUrl}" href="javascript:;" >${temp.authorityName}</a>
							</dd>
						</c:forEach>
					</dl>
				</li>
		...
		<ul class="layui-nav layui-layout-right">
			...
			<li class="layui-nav-item">
				<span class="hp-kd" style="color: red">${sessionScope.user.username}</span>
			</li>
			<li class="layui-nav-item">
			...
			<ul class="layui-nav hp-nav-none">
				<li class="layui-nav-item">
					<a href="javascript:;"  class="hp-user-name">
						...
						<span class="hp-kd">${sessionScope.user.username}</span>
					</a>
