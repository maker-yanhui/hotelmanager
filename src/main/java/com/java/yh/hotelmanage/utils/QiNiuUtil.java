...
public class QiNiuUtil {
    ...
    static String ACCESS_KEY = "01E2UtZBkHmYt05F9OO3as43NqDcFqgP0edcWyGF";
    static String SECRET_KEY = "EaC6td3hv2SrVil2Bv7OHDX-tx8RtLOCLOxDCQtK";
    //要上传的空间;对应到七牛上（自己建文件夹 注意设置公开）
    static String bucketname = "y199607"; //必须改
    //访问此空间的域名
    static String yName = "http://q6f0v4xvl.bkt.clouddn.com";
    //密钥配置
